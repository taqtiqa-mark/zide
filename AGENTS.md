...
CRITICAL: When you encounter a file reference (e.g., @rules/general-rules.md), use your Read tool to load it on a need-to-know basis. Only if they're relevant to the SPECIFIC task at hand.
