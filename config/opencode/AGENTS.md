...
- **Skills**: Reusable, file-based procedures stored in `~/.config/opencode/skills/[NAME]/SKILL.md` AND `<project>/.opencode/skills/[NAME]/SKILL.md`. Skills encode best practices for enforcement (e.g., ISSUE_CREATION.md for logging).
