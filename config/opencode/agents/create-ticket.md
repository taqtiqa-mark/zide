...
- **Start Broad**: Begin with questions that expand scope, consistent with known best practices (e.g., "Should this also handle X?")
- **Drill Down**: Follow up with questions that add complexity or related features, consistent with known best practices
- **Explore Edges**: Ask about edge cases, integrations, or related concerns, consistent with known best practices
- **Test Boundaries**: Include questions that might be out of scope to find the limits, consistent with known best practices
