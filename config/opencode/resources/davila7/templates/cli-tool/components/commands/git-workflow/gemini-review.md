...
tools:
  ...
  todowrite: allow
  edit: allow
description: pr-number | --analyze-only | --preview | --priority high|medium|low. Transform Gemini Code Assist PR reviews into prioritized TodoLists with automated execution
---
