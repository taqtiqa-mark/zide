...
Avoid vague descriptions like these three (3) examples:
...
```markdown
---
name: PDF Toolkit Bundle
description: Bundling additional content with rich Mermaid nodes
---

# PDF Toolkit – File Relationship & Preview
...
## Overview
Essential operations with pypdf
...
```markdown
---
name: PDF Forms & Scripts
description: Bundling executable scripts for PDF form handling
---
...
Depending on result, go to either 'Fillable fields' or 'Non-fillable fields' and follow those instructions.
# Fillable Fields<br>If the PDF has fillable form fields:
- Run this script from this file's directory:
`python ./extract_fields.py <input.pdf> <fields.json>`
…
~~~"] 
    --> EXTRACT["**pdf/extract_fields.py**
~~~python
