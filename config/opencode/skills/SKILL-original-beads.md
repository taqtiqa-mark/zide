...
**For complete compaction recovery workflow, read:** [references/WORKFLOWS_CORE.md](references/WORKFLOWS_CORE.md#compaction-survival)
...
Follow this checklist when starting any session where bd is available:
