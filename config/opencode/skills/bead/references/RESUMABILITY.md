...
**The test:** Would a fresh OpenCode instance (or you after 2 weeks) struggle to resume this work from the description alone? If yes, add implementation details.
...
**Problem:** Future OpenCode doesn't know:
...
**Result:** Fresh OpenCode instance can:
...
**The principle:** Help your future self (or next OpenCode) resume without rediscovering everything.
